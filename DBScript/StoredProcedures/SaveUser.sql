...
BEGIN
	UPDATE [dbo].[User]
	SET
		[Id] = @LocalId, [UserName] = @LocalUserName, [FirstName] = @LocalFirstName, [LastName] = @LocalLastName, [AspnetUserId] = @LocalAspnetUserId, [UserTypeId] = @LocalUserTypeId, [Email] = @LocalEmail, [PhoneNumber] = @LocalPhoneNumber, [Active] = @LocalActive
		WHERE [Id] = @LocalId
END
SELECT @LocalId
GO
