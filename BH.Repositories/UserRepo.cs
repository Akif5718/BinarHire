...
namespace BH.Repositories
{
    public class UserRepo :BHConnectionBase, IUserRepo
    {
        ...
        public async Task<int> SaveUser(UserModel model)
        {
            ...
            try
            {
                ...
                return await Connection
                    .ExecuteScalarAsync<int>("SaveUser", param, commandType: CommandType.StoredProcedure);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResultModel<UserModel>> GetUserById(int id)
        {
            ...
            try
            {
                ...
                resultModel.Data = await Connection
                    .QueryFirstOrDefaultAsync<UserModel>("SelectUserById", param, commandType: CommandType.StoredProcedure);
        ...
        {
            ResultModel<List<UserModel>> resultModel = new ResultModel<List<UserModel>>();
            ...
            try
            {
			    ...
			    param.Add("@SqlWhereClause", sqlWhereClause, DbType.Int32, ParameterDirection.Input, null);

                resultModel.Data = (await Connection
                    .QueryAsync<UserModel>("SelectUser", param, commandType: CommandType.StoredProcedure)).ToList();
                resultModel.Message = "Executed successfully";
                resultModel.IsSuccess = true;
        ...
        public async Task<ResultModel<int>> GetAllUserCount(UserListModel model)
        {
            ...
            try
            {
                ...
                resultModel.Data = await Connection
                    .QueryFirstAsync<int>("SelectUser", param, commandType: CommandType.StoredProcedure);
                resultModel.Message = "Executed successfully";
                resultModel.IsSuccess = true;
